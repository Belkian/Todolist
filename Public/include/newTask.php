...
<div id="ModalnewTask" class="hidden fixed top-16 shadow-2xl space-y-6 bg-cyan-700 w-full h-fit rounded-lg">
    ...
    <div style="margin: 0 4px 2px 4px;">
        <label for="name_task" class="font-bold mx-10">Task name</label>
    ...
    <div style="margin: 0 4px 2px 4px;">
        <label for="description" class="font-bold  mx-10">Task description</label>
    ...
    <div style="margin: 0 4px 2px 4px;">
        <label for="id_priority" class="font-bold  mx-10">Priority</label>
    ...
    <div style="margin: 0 4px 2px 4px;">
        <label for="id_category" class="font-bold mx-10">Category</label>
    ...
    <div style="margin: 0 4px 2px 4px;">
        <label for="date" class="font-bold mx-10">Date</label>
